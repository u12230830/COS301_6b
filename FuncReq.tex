...
\subsubsection*{Requests and Results Data Structures:}
\includegraphics[width=1\linewidth]{Images/SearchAndFilter/Filter_input_output}\\
\includegraphics[width=1\linewidth]{Images/SearchAndFilter/Search_Input_output}\\
\includegraphics[width=1\linewidth]{Images/SearchAndFilter/SearchAndFilter_input_output}\\
\subsection{Required Functionality:} 
\includegraphics[width=0.4\linewidth]{Images/SearchAndFilter/SearchAndFilter_usecase}\\
\subsection{Process Specifications:} 
\includegraphics[width=0.4\linewidth]{Images/SearchAndFilter/Search_processSpecification}\\
\includegraphics[width=0.4\linewidth]{Images/SearchAndFilter/Filter_processSpecification}\\
\includegraphics[width=0.4\linewidth]{Images/SearchAndFilter/SearchAndFilter_processSpecification}\\
